!(function (e, t) {
  ...
  function E(e, t, n) {
    ...
    return '!' !== e[0].charAt(0) ? { type: 'link', raw: n, href: r, title: i, text: e[1] } : { type: 'image', raw: n, text: C(e[1]), href: r, title: i };
  }
  var D = (function () {
      function e(e) {
        this.options = e || q;
      ...
      return (
        ...
        (t.code = function (e, t) {
          ...
          if (n) {
            ...
            return { type: 'code', raw: n[0], codeBlockStyle: 'indented', text: this.options.pedantic ? i : I(i, '\n') };
          }
        }),
        (t.fences = function (e) {
        ...
        (t.nptable = function (e) {
          ...
          if (t) {
            var n = { type: 'table', header: O(t[1].replace(/^ *| *\| *$/g, '')), align: t[2].replace(/^ *|\| *$/g, '').split(/ *\| */), cells: t[3] ? t[3].replace(/\n$/, '').split('\n') : [], raw: t[0] };
        ...
        (t.list = function (e) {
          ...
          if (t) {
            for (
              var n, r, i, s, a, l, o, c = t[0], h = t[2], u = 1 < h.length, p = { type: 'list', raw: c, ordered: u, start: u ? +h : '', loose: !1, items: [] }, g = t[0].match(this.rules.block.item), f = !1, d = g.length, k = 0;
              k < d;
              k++
            )
              (r = (c = n = g[k]).length),
                ...
                k !== d - 1 &&
                  ...
                  (1 < h.length ? 1 === i.length : 1 < i.length || (this.options.smartLists && i !== h)) && ((s = g.slice(k + 1).join('\n')), (p.raw = p.raw.substring(0, p.raw.length - s.length)), (k = d - 1))),
                (a = f || /\n\n(?!\s*$)/.test(n)),
                k !== d - 1 && ((f = '\n' === n.charAt(n.length - 1)), (a = a || f)),
                a && (p.loose = !0),
                (o = void 0),
                (l = /^\[[ xX]\] /.test(n)) && ((o = ' ' !== n[1]), (n = n.replace(/^\[[ xX]\] +/, ''))),
                p.items.push({ type: 'list_item', raw: c, task: l, checked: o, loose: a, text: n });
            return p;
          }
        }),
        (t.html = function (e) {
        ...
        (t.tag = function (e, t, n) {
          ...
          if (r)
            return (
              ...
              { type: this.options.sanitize ? 'text' : 'html', raw: r[0], inLink: t, inRawBlock: n, text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(r[0]) : C(r[0])) : r[0] }
            );
        }),
        (t.link = function (e) {
          ...
          if (t) {
            ...
            var i,
              ...
              a = '';
            return (
              (a = this.options.pedantic ? ((i = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(s)), i ? ((s = i[1]), i[3]) : '') : t[3] ? t[3].slice(1, -1) : ''),
              E(t, { href: (s = s.trim().replace(/^<([\s\S]*)>$/, '$1')) ? s.replace(this.rules.inline._escapes, '$1') : s, title: a ? a.replace(this.rules.inline._escapes, '$1') : a }, t[0])
            );
          }
        }),
        ...
        (t.autolink = function (e, t) {
          ...
          if (n) {
            var r,
              i = '@' === n[2] ? 'mailto:' + (r = C(this.options.mangle ? t(n[1]) : n[1])) : (r = C(n[1]));
  ...
  (F.em = P(F.em)
    ...
    (F.autolink = P(F.autolink).replace('scheme', F._scheme).replace('email', F._email).getRegex()),
    (F._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (F.tag = P(F.tag).replace('comment', B._comment).replace('attribute', F._attribute).getRegex()),
    (F._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (F._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/),
    (F._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (F.link = P(F.link).replace('label', F._label).replace('href', F._href).replace('title', F._title).getRegex()),
    ...
    (F.gfm.url = P(F.gfm.url, 'i').replace('email', F.gfm._extended_email).getRegex()),
    (F.breaks = U({}, F.gfm, {
  ...
  var H = (function () {
      ...
      return (
        ...
        (i.inlineTokens = function (e, t, n, r) {
          var i;
          for (void 0 === t && (t = []), void 0 === n && (n = !1), void 0 === r && (r = !1); e; )
            ...
            else if ((i = this.tokenizer.strong(e))) (e = e.substring(i.raw.length)), (i.tokens = this.inlineTokens(i.text, [], n, r)), t.push(i);
            else if ((i = this.tokenizer.em(e))) (e = e.substring(i.raw.length)), (i.tokens = this.inlineTokens(i.text, [], n, r)), t.push(i);
            ...
            else if ((i = this.tokenizer.autolink(e, V))) (e = e.substring(i.raw.length)), t.push(i);
            else if (n || !(i = this.tokenizer.url(e, V))) {
              if ((i = this.tokenizer.inlineText(e, r, G))) (e = e.substring(i.raw.length)), t.push(i);
              else if (e) {
    ...
    ie = (function () {
      ...
      return (
        (e.parse = function (e, t) {
          void 0 === t && (t = !0);
          for (var n, r, i, s, a, l, o, c, h, u, p, g, f, d, k, b, m, x = '', w = e.length, v = 0; v < w; v++)
            switch ((h = e[v]).type) {
              case 'space':
                continue;
              case 'hr':
              ...
              case 'code':
                ...
                continue;
              case 'table':
                for (l = o = '', i = h.header.length, n = 0; n < i; n++) l += this.renderer.tablecell(this.parseInline(h.tokens.header[n]), { header: !0, align: h.align[n] });
                for (o += this.renderer.tablerow(l), c = '', i = h.cells.length, n = 0; n < i; n++) {
                  for (l = '', s = (a = h.tokens.cells[n]).length, r = 0; r < s; r++) l += this.renderer.tablecell(this.parseInline(a[r]), { header: !1, align: h.align[r] });
              ...
              case 'blockquote':
                ...
                continue;
              case 'list':
                for (u = h.ordered, p = h.start, g = h.loose, i = h.items.length, c = '', n = 0; n < i; n++)
        ...
        ue.walkTokens(i, function (n) {
          'code' === n.type &&
            ...
            s(n.text, n.lang, function (e, t) {
              if (e) return a(e);
              null != t && t !== n.text && ((n.text = t), (n.escaped = !0)), 0 === --l && a();
            }));
        }),
        void (0 === l && a())
      );
